...
class DevisController extends Controller
{
    ...
    public function indexController_devis(Request $request){
        ...
        if(isset($siret_exist)){
            ...
            return redirect()->intended(route('devisCQ'))->with('update','Modification du lead réussie !');
        }else{
            $crm = new CrmModel();
            ...
            //dd("test sldkjf");
            return redirect()->intended(route('devisCQ'))->with('leadentre','Lead bien enregistré!');
        }
    ...
    public function VoirCQ($id){
        $leads = CrmModel::find($id);
        //dd($leads);
        //return view('cq.cq_contrat',compact('leads'));
        return view ('cq.cq_voir_devis_in_list',compact('leads'));
    }

    public function UpdateCqDevis($id){
        $leads = CrmModel::find($id);
        return view('cq.cq_devis',compact('leads'));
    }
