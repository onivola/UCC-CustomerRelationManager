                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="/all-leads" class="active"><i class="gi gi-table sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Liste Prospects</span></a>
                                </li>
                                <li>
                            ...
                            <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            <tr>
                                                <td class="text-center">{{ \Carbon\Carbon::parse($lead->_crm_models_created_at)->format('Y-m-d') }}</td>
                                                ...
                                                <td><a href="javascript:void(0)">{{ $lead ->Numero_SIRET }}</a></td>
                                                <td>{{ $lead ->email }}</td>
                                                <td>
                                                    @if ($etatSignature === "aucun_aucun")
                                                        <span class="label label-info">Envoyé</span>
                                                    @elseif ($etatSignature === null)
                                                        <span class="label label-warning">Enregistré</span>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="/list-to-review-page/{{ $lead -> crm_id }}" data-toggle="tooltip" title="Voir" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a>
                                                        <a href="/update-lead-list-to-command/{{ $lead -> crm_id }}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                    ...
                                                    <div class="modal fade" id="modal-contrat-dellet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <h5 class="modal-title" id="exampleModalLabel">Supprimer Prospect</h5>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form id="form-validation" action="page_forms_validation.html" method="post" class="form-horizontal form-bordered">
                                                                    <div style="margin: 22px !important;">Voulez-vous vraiment supprimer le Prospect <strong>ID_Contrat</strong></div>
