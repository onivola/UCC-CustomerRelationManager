                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="/lists-devis-all" class="active"><i class="gi gi-table sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Liste de devis</span></a>
                                </li>
                                <li>
                                ...
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>nombres total de led total</th>
                                            <th>Etat</th>
                                        ...
                                        @endphp
                                            @if ($etatSignature != "aucun_aucun" && $etatSignature != null )
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $lead->Agent }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            @php
                                                               //dd($lead-> )
                                                            @endphp
                                                            <a href="/see-quote-before-sending-it/{{ $lead->id_lead }}" data-toggle="tooltip" title="Voir" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a>
                                                            <a href="/update-lead-list-to-devis/{{ $lead->id_lead }}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                            <a href="/delete-lead/{{ $lead->id_lead }}" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                                        </div>

                                                        <!-- Modal Modification contrat -->
                                                        <div class="modal fade" id="modal-contrat-dellet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
