                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    Devis<br><small>Vous pouvez telecharger ou envoyer par email le Bon de dommande</small>
                                </h1>
                            </div>
...
@endif
                        ...
                        <div class="clearfix" style="margin-bottom:25px;">
                            <div class="btn-group pull-right">
                                ...
                                @endphp
                                @php
                                    $num_siret = session('Numero_SIRET');
                                    //$num_siret= $leads->Numero_SIRET;
                                    $leads = \App\Models\CrmModel::where('Numero_SIRET', $num_siret)->first();
                                    //dd($num_siret);
                                @endphp
                                <a href="/yousign-send-pdf/{{ $leads->id }}" class="btn btn-primary"><i class="fa fa-angle-right"></i> Envoyer</a>
                            </div>
