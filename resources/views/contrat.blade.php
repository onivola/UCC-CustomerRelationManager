                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    Enregistrer des prospects<br><small>Voici votre formulaire pour enregistrer des prospects</small>
                                </h1>
                            </div>
                        </div>
                            ...
                            <div class="">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2><strong>Formulaire de </strong>Prospect</h2>
                                    </div>
                                    <!-- END Form Validation Example Title -->

                                    <!-- Form Validation Example Content -->

        <form action="/traitement-formulaire-agent" method="POST" id="agent_form" class="form-horizontal form-bordered">
            @csrf
                ...
                <aside class="col-md-6">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="email" id="val_siret" name="email" class="form-control" value="{{ isset($leads->email) ? $leads->email : null }}" placeholder="Your username..">
