                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="/lists-lead-per-agent/{{ \Illuminate\Support\Facades\Auth::user()->name }} " class="active"><i class="gi gi-table sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Liste Prospect</span></a>
                                </li>
                                <li>
                                        ...
                                        @foreach ($leads as $lead)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="/commande-lead-de-list/{{ $lead->crm_id }}" data-toggle="tooltip" title="Voir" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></a>
                                                        <a href="/update-lead/{{ $lead->crm_id }}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                    ...
                                                    <!-- Fin Modal Modification contrat -->
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
