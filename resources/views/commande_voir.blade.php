                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="{{ route('contrat') }}" class="active"><i class="gi gi-notes_2 sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Prostect</span></a>

                                </li>
                                <li>
                                    <a href="/lists-lead-per-agent/{{ \Illuminate\Support\Facades\Auth::user()->name }}" class=""><i class="gi gi-table sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Liste Prostect</span></a>
                                </li>
                                <li>
                                    <a href="/lists-lead-per-agent/{{ \Illuminate\Support\Facades\Auth::user()->name }}" class=""><i class="gi gi-table sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Devis</span></a>
                                </li>
                                <li>
...
@endif
@if(session()->has('nonEnvoyer'))
<div class="alert alert-danger">
{{ session()->get('nonEnvoyer') }}
</div>
@endif
...
@endif
                        ...
                        <div class="block full">
                            ...
                            <div class="row block-section">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <address>
                                        RAISON SOCIALE : {{ session('Noms_commerciaux')  }}<br>
                                        ADRESSE : {{ session('Adresse_postale') }}<br>
                                        CODE POSTAL : {{ session('code_postale') }}<br>
                                        VILLE : {{ session('ville') }}<br>
                                        SIRET : {{ session('Numero_SIRET') }}
                                    </address>
                                </div>
                                <!-- END Company Info -->
                                ...
                                <div class="col-sm-6 text-right">
                                    ...
                                    <address>
                                        NOM : {{ session('name') }}<br>
                                        PRENOM : {{ session('first_name') }}<br>
                                        FONCTION : {{ session('function') }}<br><br>
                                        {{ session('phone') }} <i class="fa fa-phone"></i><br>
                                        <a href="javascript:void(0)">{{ session('email') }}</a> <i class="fa fa-envelope-o"></i>
                                    </address>
                                </div>
                                <!-- END Client Info -->
                            </div>
                                ...
                                <table class="table table-vcenter">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center"><strong>x <span class="badge">{{ session("PR30WMCEE") }}</span></strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><strong>€ 0</strong></td>
                                            <td class="text-center"><strong>x <span class="badge">{{ session("PR50WMCEE") }}</span></strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><strong>€ 0</strong></td>
                                            <td class="text-center"><strong>x <span class="badge">{{ session("PR100WMCEE") }}</span></strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><strong>€ 0</strong></td>
                                            <td class="text-center"><strong>x <span class="badge">{{ session("HUB1600RWBCEE") }}</span></strong></td>
                                ...
                                <div>
                                    <table  style="margin-left: 50px;margin-bottom:50px;">
                                        <tr>
                                            ...
                                            <td style="width: 120px; padding: 0 0 0 10px">
                        ...
                        <div class="clearfix" style="margin-bottom:25px;">
                            <div class="btn-group pull-right">
                                <a href="javascript:void(0)" class="btn btn-default"><i class="fa fa-print"></i> Enregistrer</a>
